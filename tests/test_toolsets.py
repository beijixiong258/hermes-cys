...
class TestToolsetConsistency:
    ...
    def test_hermes_platforms_share_core_tools(self):
        ...
        """
        platforms = ["hermes-cli", "hermes-telegram", "hermes-discord", "hermes-whatsapp", "hermes-slack", "hermes-signal"]
    ...
    def test_removed_platform_toolsets_are_not_available(self):
        """Removed platform toolsets cannot re-enter the default surface."""
        removed = {"homeassistant", "yuanbao", "hermes-homeassistant", "hermes-yuanbao"}
        assert removed.isdisjoint(TOOLSETS)
        assert removed.isdisjoint(set(get_all_toolsets().keys()))
        assert not (removed & set(resolve_toolset("hermes-cli")))
