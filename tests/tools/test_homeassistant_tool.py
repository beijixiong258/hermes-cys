...
class TestRegistration:
    def test_removed_tools_are_not_registered(self):
    ...
    def test_removed_tools_stay_out_when_token_set(self, monkeypatch):
        """HASS_TOKEN cannot restore the removed tools."""
