...
class TestResolveCommand:
    ...
    def test_export_is_not_a_slash_command(self):
        """Keep /export out of slash-command resolution and completion."""
        assert resolve_command("export") is None
        assert "/export" not in COMMANDS
        completions = _completions(SlashCommandCompleter(), "/ex")
        displays = {completion.display_text for completion in completions}
        assert "/export" not in displays
