...
class GatewaySlashCommandsMixin:
    ...
    async def _handle_zhuangtai_command(self, event: MessageEvent) -> str:
        """Handle /zhuangtai — show Hermes, Codex, and network status."""
        ...
        try:
            ...
            pass
        snapshot = await asyncio.to_thread(collect_status, model=model, provider=provider)
