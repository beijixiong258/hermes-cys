...
def resolve_xai_http_credentials(
    *,
    ...
    API-metered endpoints where a subscription OAuth bearer authorizes but the
    endpoint still requires an explicit key, such as ``/v1/tts`` (#87045).
    The key is read through
