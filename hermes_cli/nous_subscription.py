...
def get_gateway_eligible_tools(
    ...
    *,
    ...
    for key in _ALL_GATEWAY_KEYS:
        ...
        # tool pool and paid access may cover different categories.
...
def prompt_enable_tool_gateway(
    ...
    *,
    ...
    picks which to route through the gateway. The checklist only lists covered
    tools (the coverage filter lives in get_gateway_eligible_tools).
